...
double space_age::on_mercury() const {
    ...
    return (age_in_seconds_ / earth_seconds_per_year) / mercury_orbital_period;
}

double space_age::on_venus() const {
    constexpr double earth_seconds_per_year = 31557600.0;
    constexpr double venus_orbital_period = 0.61519726;
    return (age_in_seconds_ / earth_seconds_per_year) / venus_orbital_period;
}
...
double space_age::on_mars() const {
    ...
    return (age_in_seconds_ / earth_seconds_per_year) / mars_orbital_period;
}

double space_age::on_jupiter() const {
    constexpr double earth_seconds_per_year = 31557600.0;
    constexpr double jupiter_orbital_period = 11.862615;
    return (age_in_seconds_ / earth_seconds_per_year) / jupiter_orbital_period;
}

double space_age::on_saturn() const {
    constexpr double earth_seconds_per_year = 31557600.0;
    constexpr double saturn_orbital_period = 29.447498;
    return (age_in_seconds_ / earth_seconds_per_year) / saturn_orbital_period;
}

double space_age::on_uranus() const {
    constexpr double earth_seconds_per_year = 31557600.0;
    constexpr double uranus_orbital_period = 84.016846;
    return (age_in_seconds_ / earth_seconds_per_year) / uranus_orbital_period;
}

double space_age::on_neptune() const {
    constexpr double earth_seconds_per_year = 31557600.0;
    constexpr double neptune_orbital_period = 164.79132;
    return (age_in_seconds_ / earth_seconds_per_year) / neptune_orbital_period;
}
