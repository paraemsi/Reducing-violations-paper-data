...
private:
    ...
    boost::gregorian::date nth_weekday(int nth, int weekday) const;     // weekday: 0=Sun..6=Sat
    boost::gregorian::date last_weekday(int weekday) const;              // weekday: 0=Sun..6=Sat
    boost::gregorian::date teenth_weekday(int weekday) const;            // weekday: 0=Sun..6=Sat
};
