...
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * mercury_ratio));
}

double space_age::on_venus() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * venus_ratio));
}

double space_age::on_mars() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * mars_ratio));
}

double space_age::on_jupiter() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * jupiter_ratio));
}

double space_age::on_saturn() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * saturn_ratio));
}

double space_age::on_uranus() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * uranus_ratio));
}

double space_age::on_neptune() const noexcept
{
    return (static_cast<double>(m_seconds) / (earth_year_seconds * neptune_ratio));
}
