...
private:
    ...
    int m_year;
    boost::gregorian::date find_nth_weekday(int weekday, int n) const;
    boost::gregorian::date find_last_weekday(int weekday) const;
    boost::gregorian::date find_teenth_weekday(int weekday) const;
};
