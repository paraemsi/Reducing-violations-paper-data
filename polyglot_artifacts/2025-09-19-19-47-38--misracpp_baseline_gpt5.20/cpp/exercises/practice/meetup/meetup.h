...
private:
    boost::gregorian::date nth_weekday(int dow, int n) const noexcept;
    boost::gregorian::date last_weekday(int dow) const noexcept;
    boost::gregorian::date teenth_weekday(int dow) const noexcept;
