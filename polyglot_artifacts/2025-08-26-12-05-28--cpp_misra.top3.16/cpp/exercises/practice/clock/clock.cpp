...
{
    minute_t total_minutes = static_cast<minute_t>((m_hour * MINUTES_PER_HOUR) + m_minute + minutes);
    hour_t hour = static_cast<hour_t>(0);
    minute_t minute = static_cast<minute_t>(0);

    hour = static_cast<hour_t>(0);
